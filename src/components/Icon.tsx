...
const P: Record<IconName, JSX.Element> = {
  ...
  // ダブり→染料の交換：重なった2枚のカード → 矢印 → しずく（染料）。
  // 「重なっている＝ダブり」「しずく＝染料」で、押す前に何ができるか分かるようにする。
  dyeSwap: (
    <g>
      <rect x="2" y="6.5" width="7" height="9" rx="1.6" opacity="0.45" />
      <rect x="4.5" y="4" width="7" height="9" rx="1.6" />
      <path d="M12.4 12h4.2l-1.5-1.6 1.1-1.1 3.4 3.4-3.4 3.4-1.1-1.1L16.6 13h-4.2v-1z" fillRule="evenodd" />
      <path d="M20.2 15.4c1.3 1.6 2 2.7 2 3.6a2 2 0 11-4 0c0-.9.7-2 2-3.6z" />
    </g>
  ),
