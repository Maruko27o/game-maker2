...
export const WEEKLY_EVENTS: WeeklyEvent[] = [
  ...
  },
  {
    ...
    detail: [
      '馬券を買った「一人でレース」で1着になるたび、受信箱にたまるよ',
      '中身は育てるためのもの：育成アイテム／染料／厳選チケット／コイン',
      '1/10000 で「ラッキーボックス限定フレーム」！一度きりの特別な1枚だよ',
      '1/1000 で称号「幸運のしっぽ」！こちらも一度きり',
  ...
  },
  {
    ...
    detail: [
      '馬券を買った「一人でレース」で1着になるたび、受信箱にたまるよ',
      '中身はぜんぶコイン！1,000から、当たれば100,000コインまで',
      '1/10000 で「ゴールドボックス限定フレーム」！一度きりの特別な1枚だよ',
      '1/1000 で称号「黄金のひづめ」！こちらも一度きり',
