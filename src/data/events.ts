...
export const WEEKLY_EVENTS: WeeklyEvent[] = [
  ...
  },
  {
    ...
    lead: 'レースで1着をとると、ごほうびの箱がもらえる。',
    detail: [
      '1着になるたびにラッキーボックスが受信箱にたまるよ（×2 のように重なる）',
      '中身：コイン／育成アイテム／染料／厳選チケット（ぜんぶ常設）',
  ...
  },
  {
    ...
    lead: '週の締めくくり。土曜より中身が豪華な箱がもらえる。',
    detail: [
      '土曜と同じく1着でたまるけど、箱のランクが上！',
      '中身：大量のコイン／厳選チケット／めずらしい染料（ぜんぶ常設）',
      '1/10000 で「ゴールドボックス限定フレーム」！このゲームでいちばん出ない1枚だよ',
      '土曜にためた箱も、そのまま残るので好きなときに開けられるよ',
      '週末はレースを走りこんで、豪華な箱をねらおう！',
    ],
    status: 'soon',
  },
];
