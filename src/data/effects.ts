...
export const EFFECTS: EffectDef[] = [
  { id: 'tail_ribbon', name: 'リボンの舞', kind: 'petals', shape: 'ribbon', colors: ['#ff8ac4', '#ffd0e6'], count: 7 },
  { id: 'tail_fire', name: '炎のオーラ', kind: 'flames', shape: 'flame', colors: ['#ff7a2d', '#ffd34d'], count: 7 },
  { id: 'tail_ice', name: '氷のオーラ', kind: 'motes', shape: 'shard', colors: ['#6fd6ff', '#d6f4ff'], count: 9 },
  { id: 'tail_sparkle', name: 'きらめき', kind: 'orbit', shape: 'star', colors: ['#ffd34d', '#fff3b8'], count: 10 },
  { id: 'tail_flower', name: '花吹雪', kind: 'petals', shape: 'petal', colors: ['#ff9ec4', '#ffe2ee'], count: 9 },
  { id: 'tail_bubble', name: 'あわ', kind: 'bubbles', shape: 'bubble', colors: ['#7fe0ff', '#dff6ff'], count: 9 },
  { id: 'tail_star', name: '星のまたたき', kind: 'motes', shape: 'star', colors: ['#ffd34d', '#fff3b8'], count: 8 },
  { id: 'tail_lightning', name: '稲妻', kind: 'rays', shape: 'bolt', colors: ['#ffe066', '#fff7cf'], count: 6 },
  { id: 'tail_heart', name: 'ハートのオーラ', kind: 'motes', shape: 'heart', colors: ['#ff6f9c', '#ffd0e0'], count: 8 },
  { id: 'tail_leaf', name: '木の葉舞い', kind: 'petals', shape: 'leaf', colors: ['#69b34a', '#c8e6a0'], count: 8 },
  { id: 'tail_music', name: '音符', kind: 'motes', shape: 'note', colors: ['#a06bff', '#ddc9ff'], count: 8 },
  { id: 'tail_bell', name: '鈴の音', kind: 'motes', shape: 'bell', colors: ['#e8b73a', '#ffe9a8'], count: 7 },
  ...
  { id: 'tail_rainbow', name: '虹のアーチ', kind: 'aurora', shape: 'moon', colors: ['#ff6f6f', '#4fb0ff'] },
  { id: 'tail_candy', name: '甘い香り', kind: 'motes', shape: 'candy', colors: ['#ff7fb0', '#ffe1ee'], count: 8 },
  { id: 'tail_feather', name: '羽ふわり', kind: 'petals', shape: 'feather', colors: ['#b9d2ea', '#ffffff'], count: 8 },
  { id: 'tail_moon', name: '月明かり', kind: 'glow', shape: 'moon', colors: ['#8fa8ff', '#e6ecff'], count: 5 },
  { id: 'tail_clover', name: '幸せの風', kind: 'petals', shape: 'clover', colors: ['#5fbf5a', '#c8ecb0'], count: 8 },
  { id: 'tail_snowflake', name: '粉雪', kind: 'petals', shape: 'snow', colors: ['#9fd8f5', '#e8f7ff'], count: 10 },
  { id: 'tail_pom', name: 'ポンポン', kind: 'motes', shape: 'pom', colors: ['#ff8ac4', '#7fe0ff'], count: 9 },
  { id: 'tail_shell', name: '潮風', kind: 'bubbles', shape: 'shell', colors: ['#5fc9c0', '#d5f2ef'], count: 8 },
  { id: 'tail_cloud', name: '雲の上', kind: 'glow', shape: 'cloud', colors: ['#c6dcf4', '#ffffff'], count: 5 },
  { id: 'tail_maple', name: '紅葉舞い', kind: 'petals', shape: 'maple', colors: ['#e05a3a', '#ffb45e'], count: 8 },
  { id: 'tail_lantern', name: 'ちょうちんあかり', kind: 'glow', shape: 'lantern', colors: ['#ff9f43', '#ffe0a8'], count: 5 },
  { id: 'tail_gem', name: '宝石の輝き', kind: 'rays', shape: 'gem', colors: ['#b06bff', '#ffd7f2'], count: 6 },
