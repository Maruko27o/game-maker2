...
export const TITLES: TitleDef[] = [
  ...
  { id: 'horse_lover', name: 'ウマ好き', desc: 'ウマを5頭あつめる', tier: 1, colors: ['#8a6a3f', '#cdae83'], check: (c) => c.horses >= 5 },
  ...
  { id: 'rancher', name: '牧場主', desc: 'ウマを15頭あつめる', tier: 2, colors: ['#8f6a35', '#e0bd80'], check: (c) => c.horses >= 15 },
  ...
  { id: 'jackpot', name: '一攫千金', desc: '1レースで50万コイン以上の払戻', tier: 6, colors: ['#ffcf3a', '#fff2b6'], check: (c) => c.maxPayout >= 500_000 },
